...
public class UserRegisterRequestDto {
    ...
    @Builder
    private UserRegisterRequestDto(String email, String name, String password, String phoneNumber, String verificationCode) {
        this.email = email;
        this.name = name;
    ...
    public AuthUser toEntity(String userUuid, String encodedPassword) {
